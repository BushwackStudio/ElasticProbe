...
if [ $DISPLAY_HELP -eq 1 ]; then
	...
	echo "-S=*, --ep-credentials=*  The Elasticsearch credentials, used in the EP_CREDENTIALS constant."
...
./bin/wp-env-cli tests-wordpress "wp --allow-root plugin install https://github.com/BushwackStudio/debug-bar-elasticprobe/archive/refs/tags/0.3.0.zip"
