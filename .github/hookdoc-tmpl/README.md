...
**Upgrade Notice:** For the full list of versions that need re-syncing, check the `check_reindex_needed()` method in the [WPProbe\Upgrades](https://github.com/BushwackStudio/WpProbe/blob/dev/includes/classes/Upgrades.php) class.
