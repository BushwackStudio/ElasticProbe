...
Interested in integrating ElasticPress in your headless WordPress website? Check out [ElasticPress React](https://github.com/BushwackStudio/WpProbe/elasticpress-react).
...
A complete listing of all notable changes to ElasticPress are documented in [CHANGELOG.md](https://github.com/BushwackStudio/WpProbe/blob/develop/CHANGELOG.md).
