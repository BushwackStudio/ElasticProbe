...
<div class="ep-header-menu">
	<a href="<?php echo esc_url( $base_url . 'wpprobe' ); ?>"><img width="150" src="<?php echo esc_url( plugins_url( '/images/logo.svg', dirname( __DIR__ ) ) ); ?>"></a>
	...
	<?php if ( Utils\is_top_level_admin_context() ) : ?>
		<div class="icons">
			...
			<?php if ( $is_sync_page ) : ?>
				...
				<a class="dashicons resume-sync dashicons-controls-play" title ="<?php esc_attr_e( 'Resume Sync', 'wpprobe' ); ?>" aria-label="<?php esc_attr_e( 'Resume Sync', 'wpprobe' ); ?>"></a>
				<a class="dashicons cancel-sync dashicons-no" title="<?php esc_attr_e( 'Cancel Sync', 'wpprobe' ); ?>" aria-label="<?php esc_attr_e( 'Cancel Sync', 'wpprobe' ); ?>"></a>
			<?php endif; ?>
