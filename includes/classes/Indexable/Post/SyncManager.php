...
class SyncManager extends \ElasticProbe\SyncManager {
	...
	public function setup() {
		...
		add_filter( 'eprobe_admin_bar_status_and_summary', [ $this, 'maybe_add_doc_status_to_admin_bar_status' ] );
	...
	public function tear_down() {
		...
		remove_filter( 'eprobe_admin_bar_status_and_summary', [ $this, 'maybe_add_doc_status_to_admin_bar_status' ] );
	}
	...
	public function add_admin_bar_status( \WP_Admin_Bar $admin_bar ) {
		_deprecated_function( __METHOD__, 'ElasticProbe 1.5.0' );
	}
