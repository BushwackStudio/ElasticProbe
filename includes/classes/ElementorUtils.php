...
class ElementorUtils {
	...
	public function regenerate_cache() {
		...
		// Simply calling it will reset the transient (if the `eprobe_elementor_widgets_pre_all_widgets` filter isn't in use.)
	...
	public function get_all_widgets_in_all_templates(): array {
		 ...
		 *
		 * @since 5.3.0
		 * @hook eprobe_elementor_widgets_pre_all_widgets
		 * @param {null}   $widgets Widgets array
		 * @return {null|array} Widgets array or `null` to keep default behavior
		 */
		$pre_all_widgets = apply_filters( 'eprobe_elementor_widgets_pre_all_widgets', null );
		 ...
		 *
		 * @since 5.3.0
		 * @hook eprobe_elementor_templates_query_args
		 * @param {array} $query_args Query arguments
		 * @return {array} Modified query arguments
		 */
		$query_args = apply_filters(
			'eprobe_elementor_templates_query_args',
			[
