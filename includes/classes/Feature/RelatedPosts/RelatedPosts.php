...
class RelatedPosts extends Feature {
	...
	public function set_i18n_strings(): void {
		...
		$this->summary = '<p>' . __( 'Instantly deliver engaging and precise related content with no impact on site performance. Output related content using our block or directly in your theme using our <a href="https://wpprobe.com/resources/related-posts/#api">API functions</a>.', 'elasticprobe' ) . '</p>';

		$this->docs_url = __( 'https://wpprobe.com/resources/related-posts/', 'elasticprobe' );
	}
	...
	public function output_feature_box_long() {
		?>
		<p><?php echo wp_kses_post( __( 'Output related content using our Widget or directly in your theme using our <a href="https://wpprobe.com/resources/related-posts/#api">API functions.</a>', 'elasticprobe' ) ); ?></p>
		<?php
	}
}
