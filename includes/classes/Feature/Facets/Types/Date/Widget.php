...
class Widget extends \WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$renderer_class = apply_filters( 'eprobe_facet_renderer_class', __NAMESPACE__ . '\\Renderer', 'date', 'widget', $instance );
	...
	public function form( $instance ) {
		...
		<div class="widget-ep-facet-date">
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:', 'elasticprobe' ); ?></label>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'displayCustomDate' ) ); ?>">
					<?php esc_html_e( 'Display custom date option', 'elasticprobe' ); ?>
				</label>
			</p>
		</div>
		<?php
