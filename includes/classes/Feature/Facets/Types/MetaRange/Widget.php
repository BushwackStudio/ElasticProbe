...
class Widget extends \WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$renderer_class = apply_filters( 'eprobe_facet_renderer_class', __NAMESPACE__ . '\Renderer', 'meta-range', 'widget', $instance );
		...
		<div class="widget-ep-facet-meta-range">
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'prefix' ) ); ?>">
					<?php esc_html_e( 'Value Prefix:', 'elasticprobe' ); ?>
				</label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'suffix' ) ); ?>">
					<?php esc_html_e( 'Value Suffix:', 'elasticprobe' ); ?>
				</label>
