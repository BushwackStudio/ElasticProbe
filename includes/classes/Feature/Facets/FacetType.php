...
abstract class FacetType {
	 ...
	 *
	 * Given a block name, e.g., `elasticprobe/facet-meta` this method returns all meta fields
	...
	protected function block_template_meta_fields( string $block_name ): array {
		$block_template_utils = \ElasticProbe\get_container()->get( '\ElasticProbe\BlockTemplateUtils' );
