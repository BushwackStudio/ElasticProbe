...
class DefaultAlgorithm extends \ElasticProbe\SearchAlgorithm {
				...
				'should' => [
					[
						'multi_match' => [
							 ...
							 *
							 * @since 4.3.0
							 * @hook eprobe_{$indexable_slug}_match_phrase_boost
							 * @param {int}   $boost         Phrase boost
							 * @param {array} $search_fields Search fields
							 * @param {array} $query_vars    Query variables
							 * @return {int} New boost amount
							 */
							'boost'  => apply_filters( "eprobe_{$indexable_slug}_match_phrase_boost", 4, $search_fields, $query_vars ),
						],
					],
					[
						'multi_match' => [
							 ...
							 *
							 * @since 4.3.0
							 * @hook eprobe_{$indexable_slug}_match_boost
							 * @param {int}   $boost         Boost
							 * @param {array} $search_fields Search fields
							 * @param {array} $query_vars    Query variables
							 * @return  {int} New boost
							 */
							'boost'     => apply_filters( "eprobe_{$indexable_slug}_match_boost", 2, $search_fields, $query_vars ),
							'fuzziness' => 0,
							'operator'  => 'and',
						],
					],
					[
						'multi_match' => [
							 ...
							 *
							 * @since 4.3.0
							 * @hook eprobe_{$indexable_slug}_fuzziness_arg
							 * @param {int}   $fuzziness     Fuzziness
							 * @param {array} $search_fields Search fields
							 * @param {array} $query_vars    Query variables
							 * @return  {int} New fuzziness
							 */
							'fuzziness' => apply_filters( "eprobe_{$indexable_slug}_fuzziness_arg", 1, $search_fields, $query_vars ),
						],
					],
				],
			],
	...
	protected function apply_legacy_filters( array $query, string $indexable_slug, array $search_fields, array $query_vars ): array {
		 ...
		 *
		 * This filter exists to keep backwards-compatibility. Newer implementations should use `eprobe_post_match_phrase_boost`.
		 *
		 * @hook eprobe_match_phrase_boost
		 * @param {int}   $boost         Phrase boost
		 * @param {array} $search_fields Search fields
		 * @param {array} $query_vars    Query variables
		 * @return {int} New boost amount
		 ...
		 *
		 * This filter exists to keep backwards-compatibility. Newer implementations should use `eprobe_post_match_boost`.
		 *
		 * @hook eprobe_match_boost
		 * @param {int}   $boost         Boost
		 * @param {array} $search_fields Search fields
		 * @param {array} $query_vars    Query variables
		 * @return  {int} New boost
		 ...
		 *
		 * This filter exists to keep backwards-compatibility. Newer implementations should use `eprobe_post_fuzziness_arg`.
		 *
		 * @hook eprobe_fuzziness_arg
		 * @param {int}   $fuzziness     Fuzziness
		 * @param {array} $search_fields Search fields
		 * @param {array} $query_vars    Query variables
		 * @return  {int} New fuzziness
