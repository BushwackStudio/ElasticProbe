<?php
/**
 * ElasticProbe.com Template Manager trait for search API interactions
 *
...
/**
 * ElasticProbe.com Template Manager trait.
 *
 * This trait provides common functionality for features that interact with
 * ElasticProbe.com search APIs, including search template management and API requests.
 *
 * @since 5.3.0
 */
trait ElasticProbeComTemplateManager {
	...
	public function get_hook_prefix(): string {
		return 'eprobe_' . str_replace( '-', '_', $this->get_feature_slug() );
	}
