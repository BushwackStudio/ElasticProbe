...
class ElasticProbeCom {
	 ...
	 */
	const STATUS_TRANSIENT_NAME = 'eprobe_elasticpress_io_status';
	...
	public static function factory() {
		...
		return \ElasticProbe\get_container()->get( __CLASS__ );
	}

	/**
	 * Get status from ElasticProbe.com.
	 *
	 * @since 5.3.0
	 * @param bool $skip_cache Whether to fetch the API or use the cached messages. Defaults to false, i.e., use cache.
	 * @return array ElasticProbe.com endpoint status.
	 */
	public function get_endpoint_status( $skip_cache = false ): array {
		...
		$response = \ElasticProbe\Elasticsearch::factory()->remote_request( 'endpoint-status' );
