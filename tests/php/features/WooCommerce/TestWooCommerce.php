...
class TestWooCommerce extends WooCommerceBaseTestCase {
	 ...
	 * @since 4.5.0
	 * @group woocommerce
	 * @expectedDeprecated ElasticProbe\Feature\WooCommerce\WooCommerce::is_orders_autosuggest_available
	 */
	 ...
	 * @since 4.5.0
	 * @group woocommerce
	 * @expectedDeprecated ElasticProbe\Feature\WooCommerce\WooCommerce::is_orders_autosuggest_enabled
	 */
	 ...
	 * @since 4.2.0
	 * @group woocommerce
	 * @expectedDeprecated ElasticProbe\Feature\WooCommerce\WooCommerce::add_variations_skus_meta
	 */
	 ...
	 * @since 4.2.0
	 * @group woocommerce
	 * @expectedDeprecated ElasticProbe\Feature\WooCommerce\WooCommerce::translate_args_admin_products_list
	 */
