...
class TestInstantResults extends BaseTestCase {
	...
	public function test_construct() {
		$feature = new \ElasticProbe\Feature\InstantResults\InstantResults();
	...
	public function test_requirements_status() {
		$host_url = function () {
			return 'https://gateway.elasticprobe.com';
		};
		...
		$this->assertSame( "To use this feature you need to be an <a href='https://elasticprobe.com'>ElasticProbe.com</a> customer or implement a <a href='https://github.com/BushwackStudio/elasticprobe-proxy'>custom proxy</a>.", $status->message[0] );
	}
	...
	public function test_get_hook_prefix() {
		$feature = \ElasticProbe\Features::factory()->get_registered_feature( 'instant-results' );
		$this->assertSame( 'eprobe_instant_results', $feature->get_hook_prefix() );
	}
