...
class TestDidYouMean extends BaseTestCase {
	...
	public function set_up() {
		...
		ElasticProbe\Features::factory()->activate_feature( 'did-you-mean' );
	...
	public function testConstruct() {
		$instance = new ElasticProbe\Feature\DidYouMean\DidYouMean();
	...
	public function testGetSearchSuggestionMethod() {
		...
		$this->assertEquals( $expected, ElasticProbe\Features::factory()->get_registered_feature( 'did-you-mean' )->get_suggestion( $query ) );
	}
	...
	public function testGetSearchSuggestionMethodReturnsSuggestionForMainQuery() {
		...
		$expected = sprintf( '<span class="ep-spell-suggestion">Did you mean: <a href="%s">test</a>?</span>', get_search_link( 'test' ) );
		$this->assertEquals( $expected, ElasticProbe\Features::factory()->get_registered_feature( 'did-you-mean' )->get_suggestion() );
	}
	...
	public function testGetSearchSuggestionMethodReturnsFalseIfOtherThanWpQueryIsPassed() {
		$query = new \stdClass();
		$this->assertFalse( ElasticProbe\Features::factory()->get_registered_feature( 'did-you-mean' )->get_suggestion( $query ) );
	}
	...
	public function testGetSearchSuggestionMethodFilter() {
		...
		$this->assertEquals( $expected_result, ElasticProbe\Features::factory()->get_registered_feature( 'did-you-mean' )->get_suggestion( $query ) );
	}
	...
	public function testMapping() {
		...
		$mapping = ElasticProbe\Indexables::factory()->get( 'post' )->generate_mapping();
	...
	public function testGetOriginalSearchTerm() {
		...
		$html = ElasticProbe\Features::factory()->get_registered_feature( 'did-you-mean' )->get_original_search_term();
