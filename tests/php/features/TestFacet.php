...
class TestFacet extends BaseTestCase {
	 ...
	 * @group facets
	 */
	public function test_setup_eprobe_facet_enabled_in_editor() {
	...
	public function testFacetTypeRegistration() {
		$facet_type = $this->getMockForAbstractClass( '\ElasticProbe\Feature\Facets\FacetType' );
	...
	/**
	 * Test eprobe_is_facetable filter throws deprecated warning.
	 *
	 * @since 5.3.0
	 * @group facets
	 *
	 * @expectedDeprecated eprobe_is_facetable
	 */
	public function test_eprobe_is_facetable_throws_deprecated_warning() {
	...
	/**
	 * Test eprobe_facet_sync_aggregations_to_global filter
	 *
	 * @expectedIncorrectUsage ElasticProbe\Feature\Facets\Facets::set_query_aggregations
	 *
	 * @since 5.3.0
	 * @group facets
	 */
	public function test_eprobe_facet_sync_aggregations_to_global_filter() {
		global $wp_the_query, $wp_query;

		Features::factory()->get_registered_feature( 'facets' );

		add_filter( 'eprobe_facet_sync_aggregations_to_global', '__return_true' );
