...
class TestTermMultisite extends BaseTestCase {
	...
	public function set_up() {
		...
		foreach ( $sites as $site ) {
			...
			ElasticProbe\Indexables::factory()->get( 'term' )->put_mapping();
			$indexes[] = ElasticProbe\Indexables::factory()->get( 'term' )->get_index_name();

			restore_current_blog();
		}

		ElasticProbe\Indexables::factory()->get( 'term' )->delete_network_alias();
		ElasticProbe\Indexables::factory()->get( 'term' )->create_network_alias( $indexes );
