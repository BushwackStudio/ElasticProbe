...
class TestUtils extends BaseTestCase {
	...
	public function testIsSiteIndexableByDefault() {
		...
		$this->assertTrue( ElasticProbe\Utils\is_site_indexable() );
	}
	...
	public function testIsSiteIndexableByDefaultSpam() {
		...
		$this->assertFalse( ElasticProbe\Utils\is_site_indexable() );
	...
	public function testSanitizeCredentials() {
		...
		$creds = \ElasticProbe\Utils\sanitize_credentials( false );
		...
		$creds = \ElasticProbe\Utils\sanitize_credentials( [] );
